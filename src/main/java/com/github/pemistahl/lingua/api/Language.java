...
public enum Language {
    ...
    Language(IsoCode639_1 isoCode639_1, IsoCode639_3 isoCode639_3, EnumSet<Alphabet> alphabets,
    ...
    public static Language getByIsoCode639_1(IsoCode639_1 isoCode) {
        return Arrays.stream(values())
            ...
            .findFirst()
            .orElseThrow(() -> new IllegalArgumentException("No language found with ISO code 639-1: " + isoCode));
    }
    ...
    public static Language getByIsoCode639_3(IsoCode639_3 isoCode) {
        return Arrays.stream(values())
            ...
            .findFirst()
            .orElseThrow(() -> new IllegalArgumentException("No language found with ISO code 639-3: " + isoCode));
    }
